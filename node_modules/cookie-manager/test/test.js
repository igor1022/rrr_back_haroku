...
cm.store( 
	...
	[
		...
		'cnameSecure2=cval1sec=9; Expires='+date+'; domain=.example.com; path=/; secure',
...
describe('Cookie-manager',function(){
	...
	describe('#now',function(){
		it('Should return correct cookie string',function(){
			...
			.should.equal('cname=cval; cnameSecure=cval1sec; cnameSecure2=cval1sec=9; cnameHttpOnly=cval1Http; cname2=cval2');
